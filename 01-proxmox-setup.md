...
!["Select boot form usb from EUFI menu"](./InitialImages/BootFromUsb.jpeg)  
!["Image of Proxmox installation screen"](./InitialImages/InstallProxMox.jpg)

- Configured static IP (192.168.0.50)

![Proxmox IP configuration screen](./InitialImages/ConfigureProxMox.jpg)

- Established network connectivity via Ethernet
- Accessed web interface successfully

![Proxmox application in browser](./InitialImages/ProxmoxBrowser.jpg)
